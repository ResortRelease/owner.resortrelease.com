      ...
      function calcYears(){
        if(flag == true) {
          ...
          for(var i = 0; i < 100; i++){
            ...
            if(i == 8){ 
							x10.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>10 years</div>").css("display", "block"); 
            }
            if(i == 13){ 
              x15.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>15 years</div>").css("display", "block"); 
						}
						if(i == 18){ 
              x20.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>20 years</div>").css("display", "block"); 
						}
						if(i == 23){ 
              x25.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>25 years</div>").css("display", "block"); 
						}
						if(i == 48){ 
              x50.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>50 years</div>").css("display", "block"); 
            }
            if(i == 97){ 
							x99.html("$"+addCommas(sumTotal.toFixed(2))+"<div class='small-text text-center'>99 years</div>").css("display", "block");
							x99.removeClass('blue').addClass('red');
							jQuery.cookie('showPrice', '$'+addCommas(sumTotal.toFixed(2)));
              showPriceBanner();
            }
            a = calcA
            b = calcB
