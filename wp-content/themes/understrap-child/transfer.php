...
<div id="breadcrumbs"><!-- Breadcrumbs -->
	<nav aria-label="breadcrumb" class="container">
      ...
      <li class="breadcrumb-item 7 page-label" data-page="7">7</li>
      <li class="breadcrumb-item 8 page-label" data-page="8">8</li>
		</ol>
	</nav>
</div><!-- End Breadcrumbs -->
<div id="content">
	<?php include("transfer-1.php");?>
</div>
<?php get_footer(); ?>
<script>
	// Load Current Page
	...
	function ajaxCall(currentPage){
		jQuery.ajax({url: "../wp-content/themes/understrap-child/transfer-"+ currentPage +".php", 
		type: 'GET',
