...
if (!$user_ID){
    ...
    if($_POST['action'] == "tg_pwd_reset"){
      ...
      else echo '<div class="success margin-top-20 text-center" style="color:white;padding: 5px;">We have just sent you an email with Password reset instructions.</div>';
    }
